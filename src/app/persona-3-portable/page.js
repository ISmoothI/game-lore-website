...
export default function MainMenu() {
    ...
    const colorOptions = {
        ...
        '--light-bg': `var(--light-${colorScheme}-bg)`,
        '--mid-bg': `var(--mid-${colorScheme}-bg)`,
        '--dark-bg': `var(--dark-${colorScheme}-bg)`,
        '--box': `var(--${colorScheme}-box)`,
        '--box-shadow': `var(--${colorScheme}-box-shadow)`,
        '--underline': `var(--${colorScheme}-underline)`,
    }
    ...
    return (
        <>
            <div style={colorOptions} className={`${styles.page} ${inter.className}`}>
                        ...
                        <div className={styles.status__section}>
                            ...
                            <div className={styles.status}>
                                ...
                                <div className={styles.health}>
                                    ...
                                    <div className={styles.healthpointcontainer__base}>
                                ...
                                <div className={styles.spirit}>
                                    ...
                                    <div className={styles.spiritpointcontainer__base}>
                                        <div style={{width: `${percentageCalc(currSpirit, maxSpirit)}%`}} className={styles.spirit__fill} />
                                    </div>
                                </div>
                            </div>
                            <div className={styles.condition}>
                                <div className={styles.condition__container} onClick={() => setCurrConditionIndex((currConditionIndex + 1) % totalConditionAmount)}>
